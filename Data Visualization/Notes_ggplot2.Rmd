...
software<-read.csv("https://raw.githubusercontent.com/hmendozar17/R-Learning/master/Datasets/softwareESP.csv", header=TRUE,sep = ";")
...
```{r}
ggplot(software, aes(x = software$Sex)) + geom_bar()
```
